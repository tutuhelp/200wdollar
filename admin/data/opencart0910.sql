...
-- 正在导出表  opencart.oc_affiliate_activity 的数据：0 rows
...
-- 导出  表 opencart.oc_affiliate_login 结构
...
-- 正在导出表  opencart.oc_affiliate_login 的数据：0 rows
...
-- 导出  表 opencart.oc_affiliate_transaction 结构
...
-- 正在导出表  opencart.oc_affiliate_transaction 的数据：0 rows
...
-- 正在导出表  opencart.oc_api 的数据：1 rows
DELETE FROM `oc_api`;
/*!40000 ALTER TABLE `oc_api` DISABLE KEYS */;
INSERT INTO `oc_api` (`api_id`, `name`, `key`, `status`, `date_added`, `date_modified`) VALUES
	(1, 'Default', '', 1, '2016-09-10 12:27:32', '2016-09-10 12:27:32');
/*!40000 ALTER TABLE `oc_api` ENABLE KEYS */;


-- 导出  表 opencart.oc_api_ip 结构
...
-- 正在导出表  opencart.oc_attribute 的数据：11 rows
...
-- 导出  表 opencart.oc_attribute_description 结构
...
-- 正在导出表  opencart.oc_attribute_description 的数据：11 rows
...
-- 导出  表 opencart.oc_attribute_group 结构
...
-- 正在导出表  opencart.oc_attribute_group 的数据：4 rows
...
-- 导出  表 opencart.oc_attribute_group_description 结构
...
-- 正在导出表  opencart.oc_attribute_group_description 的数据：4 rows
...
-- 正在导出表  opencart.oc_banner 的数据：3 rows
...
-- 导出  表 opencart.oc_banner_image 结构
...
-- 正在导出表  opencart.oc_banner_image 的数据：14 rows
...
-- 正在导出表  opencart.oc_cart 的数据：~1 rows (大约)
DELETE FROM `oc_cart`;
/*!40000 ALTER TABLE `oc_cart` DISABLE KEYS */;
INSERT INTO `oc_cart` (`cart_id`, `api_id`, `customer_id`, `session_id`, `product_id`, `recurring_id`, `option`, `quantity`, `date_added`) VALUES
	(4, 0, 1, 'qp8gmig0hodorjsv806enk6863', 40, 0, '[]', 1, '2016-09-10 14:12:55');
/*!40000 ALTER TABLE `oc_cart` ENABLE KEYS */;


-- 导出  表 opencart.oc_category 结构
...
-- 正在导出表  opencart.oc_category 的数据：38 rows
...
-- 导出  表 opencart.oc_category_description 结构
...
-- 正在导出表  opencart.oc_category_description 的数据：38 rows
...
-- 导出  表 opencart.oc_category_filter 结构
...
-- 正在导出表  opencart.oc_category_filter 的数据：0 rows
...
-- 导出  表 opencart.oc_category_path 结构
...
-- 正在导出表  opencart.oc_category_path 的数据：71 rows
...
-- 导出  表 opencart.oc_category_to_layout 结构
...
-- 正在导出表  opencart.oc_category_to_layout 的数据：0 rows
...
-- 导出  表 opencart.oc_category_to_store 结构
...
-- 正在导出表  opencart.oc_category_to_store 的数据：38 rows
...
-- 正在导出表  opencart.oc_country 的数据：253 rows
...
-- 正在导出表  opencart.oc_coupon 的数据：3 rows
...
-- 导出  表 opencart.oc_coupon_category 结构
...
-- 正在导出表  opencart.oc_coupon_category 的数据：0 rows
...
-- 导出  表 opencart.oc_coupon_history 结构
...
-- 正在导出表  opencart.oc_coupon_history 的数据：0 rows
...
-- 导出  表 opencart.oc_coupon_product 结构
...
-- 正在导出表  opencart.oc_coupon_product 的数据：0 rows
...
-- 正在导出表  opencart.oc_currency 的数据：3 rows
DELETE FROM `oc_currency`;
/*!40000 ALTER TABLE `oc_currency` DISABLE KEYS */;
INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
	(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.75330001, 1, '2016-09-10 17:19:19'),
	(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-09-10 17:19:19'),
	(3, 'Euro', 'EUR', '', '€', '2', 0.89039999, 1, '2016-09-10 17:19:19');
/*!40000 ALTER TABLE `oc_currency` ENABLE KEYS */;


-- 导出  表 opencart.oc_customer 结构
...
-- 正在导出表  opencart.oc_customer 的数据：0 rows
...
INSERT INTO `oc_customer` (`customer_id`, `customer_group_id`, `store_id`, `language_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `salt`, `cart`, `wishlist`, `newsletter`, `address_id`, `custom_field`, `ip`, `status`, `approved`, `safe`, `token`, `code`, `date_added`) VALUES
	(1, 1, 0, 1, 'seven', 'tu', '865334669@qq.com', '18626870286', '', '25c102b9e58ebc9a7a6d62e70258b8d37862ffab', 'FVlHp7ceM', NULL, NULL, 0, 1, '', '127.0.0.1', 1, 1, 0, '', '', '2016-09-10 14:12:55');
/*!40000 ALTER TABLE `oc_customer` ENABLE KEYS */;


-- 导出  表 opencart.oc_customer_activity 结构
...
-- 正在导出表  opencart.oc_customer_activity 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_group 结构
...
-- 正在导出表  opencart.oc_customer_group 的数据：1 rows
...
-- 导出  表 opencart.oc_customer_group_description 结构
...
-- 正在导出表  opencart.oc_customer_group_description 的数据：1 rows
...
-- 导出  表 opencart.oc_customer_history 结构
...
-- 正在导出表  opencart.oc_customer_history 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_ip 结构
...
-- 正在导出表  opencart.oc_customer_login 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_online 结构
...
-- 正在导出表  opencart.oc_customer_online 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_reward 结构
...
-- 正在导出表  opencart.oc_customer_reward 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_search 结构
...
-- 正在导出表  opencart.oc_customer_search 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_transaction 结构
...
-- 正在导出表  opencart.oc_customer_transaction 的数据：0 rows
...
-- 导出  表 opencart.oc_customer_wishlist 结构
...
-- 正在导出表  opencart.oc_customer_wishlist 的数据：0 rows
...
-- 导出  表 opencart.oc_custom_field 结构
...
-- 正在导出表  opencart.oc_custom_field_customer_group 的数据：0 rows
...
-- 导出  表 opencart.oc_custom_field_description 结构
...
-- 正在导出表  opencart.oc_custom_field_description 的数据：0 rows
...
-- 导出  表 opencart.oc_custom_field_value 结构
...
-- 正在导出表  opencart.oc_custom_field_value 的数据：0 rows
...
-- 导出  表 opencart.oc_custom_field_value_description 结构
...
-- 正在导出表  opencart.oc_custom_field_value_description 的数据：0 rows
...
-- 正在导出表  opencart.oc_download_description 的数据：0 rows
...
-- 正在导出表  opencart.oc_event 的数据：1 rows
...
-- 正在导出表  opencart.oc_extension 的数据：28 rows
...
INSERT INTO `oc_extension` (`extension_id`, `type`, `code`) VALUES
	...
	(28, 'dashboard', 'chart'),
	(37, 'captcha', 'basic_captcha'),
	(30, 'payment', 'bank_transfer'),
	(31, 'payment', 'pp_express'),
	(32, 'payment', 'pp_payflow'),
	(33, 'payment', 'pp_payflow_iframe'),
	(34, 'payment', 'pp_pro'),
	(35, 'payment', 'pp_pro_iframe'),
	(36, 'payment', 'pp_standard');
/*!40000 ALTER TABLE `oc_extension` ENABLE KEYS */;


-- 导出  表 opencart.oc_filter 结构
...
-- 正在导出表  opencart.oc_filter_description 的数据：0 rows
...
-- 导出  表 opencart.oc_filter_group 结构
...
-- 正在导出表  opencart.oc_filter_group_description 的数据：0 rows
...
-- 正在导出表  opencart.oc_geo_zone 的数据：2 rows
...
-- 导出  表 opencart.oc_information 结构
...
-- 正在导出表  opencart.oc_information 的数据：4 rows
...
-- 导出  表 opencart.oc_information_description 结构
...
-- 正在导出表  opencart.oc_information_description 的数据：4 rows
...
-- 导出  表 opencart.oc_information_to_layout 结构
...
-- 正在导出表  opencart.oc_information_to_layout 的数据：0 rows
...
-- 导出  表 opencart.oc_information_to_store 结构
...
-- 正在导出表  opencart.oc_information_to_store 的数据：4 rows
...
-- 正在导出表  opencart.oc_language 的数据：1 rows
...
-- 正在导出表  opencart.oc_layout 的数据：13 rows
...
-- 导出  表 opencart.oc_layout_module 结构
...
-- 正在导出表  opencart.oc_layout_module 的数据：10 rows
...
-- 导出  表 opencart.oc_layout_route 结构
...
-- 正在导出表  opencart.oc_layout_route 的数据：13 rows
...
-- 导出  表 opencart.oc_length_class 结构
...
-- 正在导出表  opencart.oc_length_class 的数据：3 rows
...
-- 导出  表 opencart.oc_length_class_description 结构
...
-- 正在导出表  opencart.oc_length_class_description 的数据：3 rows
...
-- 正在导出表  opencart.oc_manufacturer 的数据：6 rows
...
-- 导出  表 opencart.oc_manufacturer_to_store 结构
...
-- 正在导出表  opencart.oc_manufacturer_to_store 的数据：6 rows
...
-- 正在导出表  opencart.oc_menu_description 的数据：0 rows
...
-- 导出  表 opencart.oc_menu_module 结构
...
-- 正在导出表  opencart.oc_module 的数据：5 rows
...
-- 正在导出表  opencart.oc_option 的数据：11 rows
...
-- 导出  表 opencart.oc_option_description 结构
...
-- 正在导出表  opencart.oc_option_description 的数据：11 rows
...
-- 导出  表 opencart.oc_option_value 结构
...
-- 正在导出表  opencart.oc_option_value 的数据：14 rows
...
-- 导出  表 opencart.oc_option_value_description 结构
...
-- 正在导出表  opencart.oc_option_value_description 的数据：14 rows
...
-- 正在导出表  opencart.oc_order 的数据：0 rows
...
INSERT INTO `oc_order` (`order_id`, `invoice_no`, `invoice_prefix`, `store_id`, `store_name`, `store_url`, `customer_id`, `customer_group_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `custom_field`, `payment_firstname`, `payment_lastname`, `payment_company`, `payment_address_1`, `payment_address_2`, `payment_city`, `payment_postcode`, `payment_country`, `payment_country_id`, `payment_zone`, `payment_zone_id`, `payment_address_format`, `payment_custom_field`, `payment_method`, `payment_code`, `shipping_firstname`, `shipping_lastname`, `shipping_company`, `shipping_address_1`, `shipping_address_2`, `shipping_city`, `shipping_postcode`, `shipping_country`, `shipping_country_id`, `shipping_zone`, `shipping_zone_id`, `shipping_address_format`, `shipping_custom_field`, `shipping_method`, `shipping_code`, `comment`, `total`, `order_status_id`, `affiliate_id`, `commission`, `marketing_id`, `tracking`, `language_id`, `currency_id`, `currency_code`, `currency_value`, `ip`, `forwarded_ip`, `user_agent`, `accept_language`, `date_added`, `date_modified`) VALUES
	(1, 0, 'INV-2013-00', 0, 'Your Store', 'http://opencart.web/', 0, 1, 'seven', 'tu', '865334669@qq.com', '18626870286', '', '[]', 'seven', 'tu', '', 'hangzhou binjiangqu', '', 'hangzhou', '31000', 'United Kingdom', 222, 'Blaenau Gwent', 3520, '', '[]', 'Cash On Delivery', 'cod', 'seven', 'tu', '', 'hangzhou binjiangqu', '', 'hangzhou', '31000', 'United Kingdom', 222, 'Blaenau Gwent', 3520, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 131.2000, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:48.0) Gecko/20100101 Firefox/48.0', 'en-US,en;q=0.5', '2016-09-10 13:51:35', '2016-09-10 13:51:40'),
	(2, 0, 'INV-2013-00', 0, 'Your Store', 'http://opencart.web/', 1, 1, 'seven', 'tu', '865334669@qq.com', '18626870286', '', '', 'seven', 'tu', '', 'henan nanyang home', '', 'nanyang', '31000', 'United Kingdom', 222, 'Aberdeen', 3513, '', '[]', 'PayPal', 'pp_standard', 'seven', 'tu', '', 'henan nanyang home', '', 'nanyang', '31000', 'United Kingdom', 222, 'Aberdeen', 3513, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 131.2000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:48.0) Gecko/20100101 Firefox/48.0', 'en-US,en;q=0.5', '2016-09-10 14:13:16', '2016-09-10 14:13:16');
/*!40000 ALTER TABLE `oc_order` ENABLE KEYS */;


-- 导出  表 opencart.oc_order_custom_field 结构
...
-- 正在导出表  opencart.oc_order_custom_field 的数据：0 rows
...
-- 导出  表 opencart.oc_order_history 结构
...
-- 正在导出表  opencart.oc_order_product 的数据：0 rows
...
-- 导出  表 opencart.oc_order_recurring 结构
...
-- 正在导出表  opencart.oc_order_recurring 的数据：0 rows
...
-- 导出  表 opencart.oc_order_recurring_transaction 结构
...
-- 正在导出表  opencart.oc_order_recurring_transaction 的数据：0 rows
...
-- 导出  表 opencart.oc_order_status 结构
...
-- 正在导出表  opencart.oc_order_status 的数据：14 rows
...
-- 导出  表 opencart.oc_order_total 结构
...
-- 正在导出表  opencart.oc_order_total 的数据：0 rows
...
-- 导出  表 opencart.oc_order_voucher 结构
...
-- 正在导出表  opencart.oc_order_voucher 的数据：0 rows
...
-- 正在导出表  opencart.oc_product 的数据：19 rows
...
INSERT INTO `oc_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
	...
	(40, 'product 11', '', '', '', '', '', '', '', 969, 5, 'catalog/demo/iphone_1.jpg', 8, 1, 101.0000, 0, 9, '2009-02-03', 10.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 3, '2009-02-03 21:07:12', '2011-09-30 01:06:53'),
	...
	(50, 'iphone7model', 'sku-001', '', '', '', '', '', '', 100, 6, '', 0, 1, 100.0000, 0, 0, '2016-09-10', 20.00000000, 1, 100.00000000, 100.00000000, 90.00000000, 1, 1, 1, 1, 1, 0, '2016-09-10 14:29:01', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `oc_product` ENABLE KEYS */;


-- 导出  表 opencart.oc_product_attribute 结构
...
-- 正在导出表  opencart.oc_product_attribute 的数据：5 rows
...
-- 导出  表 opencart.oc_product_description 结构
...
-- 正在导出表  opencart.oc_product_description 的数据：19 rows
...
INSERT INTO `oc_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
	...
	(50, 1, 'This is iphone7', '', '', 'this is iphone7', '', '');
/*!40000 ALTER TABLE `oc_product_description` ENABLE KEYS */;


-- 导出  表 opencart.oc_product_discount 结构
...
-- 正在导出表  opencart.oc_product_discount 的数据：3 rows
...
-- 导出  表 opencart.oc_product_filter 结构
...
-- 正在导出表  opencart.oc_product_filter 的数据：0 rows
...
-- 导出  表 opencart.oc_product_image 结构
...
-- 正在导出表  opencart.oc_product_image 的数据：61 rows
...
-- 导出  表 opencart.oc_product_option 结构
...
-- 正在导出表  opencart.oc_product_option 的数据：12 rows
...
-- 导出  表 opencart.oc_product_option_value 结构
...
-- 正在导出表  opencart.oc_product_option_value 的数据：16 rows
...
-- 导出  表 opencart.oc_product_recurring 结构
...
-- 正在导出表  opencart.oc_product_recurring 的数据：0 rows
...
-- 导出  表 opencart.oc_product_related 结构
...
-- 正在导出表  opencart.oc_product_related 的数据：4 rows
...
-- 导出  表 opencart.oc_product_reward 结构
...
-- 正在导出表  opencart.oc_product_reward 的数据：19 rows
...
-- 导出  表 opencart.oc_product_special 结构
...
-- 正在导出表  opencart.oc_product_special 的数据：3 rows
...
-- 导出  表 opencart.oc_product_to_category 结构
...
-- 正在导出表  opencart.oc_product_to_category 的数据：30 rows
...
-- 导出  表 opencart.oc_product_to_download 结构
...
-- 正在导出表  opencart.oc_product_to_download 的数据：0 rows
...
-- 导出  表 opencart.oc_product_to_layout 结构
...
-- 正在导出表  opencart.oc_product_to_layout 的数据：0 rows
...
-- 导出  表 opencart.oc_product_to_store 结构
...
-- 正在导出表  opencart.oc_product_to_store 的数据：19 rows
...
-- 正在导出表  opencart.oc_recurring_description 的数据：0 rows
...
-- 正在导出表  opencart.oc_return_action 的数据：3 rows
...
-- 导出  表 opencart.oc_return_history 结构
...
-- 正在导出表  opencart.oc_return_history 的数据：0 rows
...
-- 导出  表 opencart.oc_return_reason 结构
...
-- 正在导出表  opencart.oc_return_reason 的数据：5 rows
...
-- 导出  表 opencart.oc_return_status 结构
...
-- 正在导出表  opencart.oc_return_status 的数据：3 rows
...
-- 正在导出表  opencart.oc_setting 的数据：173 rows
...
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
	...
	(174, 0, 'config', 'config_email', 'tutuhelp@qq.com', 0),
	...
	(175, 0, 'config', 'config_encryption', '', 0),
	...
	(207, 0, 'pp_standard', 'pp_standard_failed_status_id', '7', 0),
	(206, 0, 'pp_standard', 'pp_standard_expired_status_id', '7', 0),
	(205, 0, 'pp_standard', 'pp_standard_denied_status_id', '7', 0),
	(204, 0, 'pp_standard', 'pp_standard_completed_status_id', '7', 0),
	(203, 0, 'pp_standard', 'pp_standard_canceled_reversal_status_id', '7', 0),
	(202, 0, 'pp_standard', 'pp_standard_sort_order', '', 0),
	(201, 0, 'pp_standard', 'pp_standard_status', '1', 0),
	(200, 0, 'pp_standard', 'pp_standard_geo_zone_id', '0', 0),
	(199, 0, 'pp_standard', 'pp_standard_total', '', 0),
	(198, 0, 'pp_standard', 'pp_standard_transaction', '0', 0),
	(197, 0, 'pp_standard', 'pp_standard_debug', '0', 0),
	(196, 0, 'pp_standard', 'pp_standard_test', '0', 0),
	(195, 0, 'pp_standard', 'pp_standard_email', 'tutuhelp@qq.com', 0),
	(208, 0, 'pp_standard', 'pp_standard_pending_status_id', '7', 0),
	(209, 0, 'pp_standard', 'pp_standard_processed_status_id', '7', 0),
	(210, 0, 'pp_standard', 'pp_standard_refunded_status_id', '7', 0),
	(211, 0, 'pp_standard', 'pp_standard_reversed_status_id', '7', 0),
	(212, 0, 'pp_standard', 'pp_standard_voided_status_id', '7', 0),
	(213, 0, 'basic_captcha', 'basic_captcha_status', '1', 0);
/*!40000 ALTER TABLE `oc_setting` ENABLE KEYS */;


-- 导出  表 opencart.oc_stock_status 结构
...
-- 正在导出表  opencart.oc_stock_status 的数据：4 rows
...
-- 正在导出表  opencart.oc_tax_class 的数据：2 rows
...
-- 正在导出表  opencart.oc_tax_rate 的数据：2 rows
...
-- 导出  表 opencart.oc_tax_rate_to_customer_group 结构
...
-- 正在导出表  opencart.oc_tax_rate_to_customer_group 的数据：2 rows
...
-- 正在导出表  opencart.oc_tax_rule 的数据：4 rows
...
-- 正在导出表  opencart.oc_url_alias 的数据：67 rows
...
-- 正在导出表  opencart.oc_user 的数据：1 rows
DELETE FROM `oc_user`;
/*!40000 ALTER TABLE `oc_user` DISABLE KEYS */;
INSERT INTO `oc_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
	(1, 1, 'admin', '3b5e342425c823e681454258611b822dc584d385', 'kbxFoypDR', 'John', 'Doe', 'tutuhelp@qq.com', '', '', '127.0.0.1', 1, '2016-09-10 12:27:32');
/*!40000 ALTER TABLE `oc_user` ENABLE KEYS */;


-- 导出  表 opencart.oc_user_group 结构
...
-- 正在导出表  opencart.oc_voucher_history 的数据：0 rows
...
-- 导出  表 opencart.oc_voucher_theme 结构
...
-- 正在导出表  opencart.oc_voucher_theme 的数据：3 rows
...
-- 导出  表 opencart.oc_voucher_theme_description 结构
...
-- 正在导出表  opencart.oc_voucher_theme_description 的数据：3 rows
...
-- 导出  表 opencart.oc_weight_class 结构
...
-- 正在导出表  opencart.oc_weight_class 的数据：4 rows
...
-- 导出  表 opencart.oc_weight_class_description 结构
...
-- 正在导出表  opencart.oc_weight_class_description 的数据：4 rows
...
-- 正在导出表  opencart.oc_zone 的数据：4,109 rows
DELETE FROM `oc_zone`;
...
-- 导出  表 opencart.oc_zone_to_geo_zone 结构
...
-- 正在导出表  opencart.oc_zone_to_geo_zone 的数据：109 rows
